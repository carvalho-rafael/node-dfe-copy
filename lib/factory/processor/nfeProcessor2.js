...
class NFeProcessor {
     ...
     */
    async processarDocumento(documento, assincrono = false) {
        let result = await this.executar(documento, assincrono);
        return result;
    }
    async executar(documento, assincrono = false) {
        ...
        let result = {};
        try {
            result = await this.enviaProcessor.executar(documento, assincrono);
            let retEnviNFe = null;
