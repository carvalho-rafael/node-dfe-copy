    ...
    async executar(documento, assincrono = false) {
        ...
        try {
            ...
            const a = new Promise(resolve => {
                xsd_schema_validator_1.validateXML('<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + xmlAssinado, path.resolve(__dirname, 'nfe_v4.00.xsd'), (_err, result) => {
                    resolve(result);
                });
            });
            ...
            if (!a.valid) {
                ...
                result.error = validatorResponse === null || validatorResponse === void 0 ? void 0 : validatorResponse.messages;
                return result;
            }
